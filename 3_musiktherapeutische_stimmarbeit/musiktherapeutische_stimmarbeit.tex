...
\begin{figure}
  ...
  \caption[]{dings digger \subref{fig:kehlkopf_vorne} zeigt von vorne, \subref{fig:kehlkopf_seite}  von der seitepopeite}
  \label{fig:kehlkopf}
\end{figure}
...
\begin{figure}
  ...
  \caption[]{dings digger \subref{fig:zwerchfell} zeigt von vorne, \subref{fig:zwerchfell_atembewegung}  von der seitepopeite}
...
\begin{figure}
  ...
  \caption[]{dings digger \subref{fig:stimmlippen_offen} zeigt von vorne, \subref{fig:stimmlippen_phonationsstellung}  von der seitepopeite}
